Introduction
------------
The Producer Entities module provides a fully working yet generic example
...
Admnistration > Structure > Producer Types

You can add producer entities via

Administration > Content > Producers

Keep in mind that you need to create some Producer Types before you can add entities.


Using the code in your projects
-------------------------------
The way I envision using the module in my own projects is, for the time being,
searching and replacing the word "producer" with the actual name I want to give my
...
Your would only every really need to change the Producer entity and Producer type as ProducerType
...
producer.admin.inc and customize the behaviour of your entity on save, delete which you
do via the ProducerController class in producer.module.
...
to your table)  - just like the producer entity does with the checkbox - there is nothing
else you need to do. If you have added new columns you need to add support for them
in $producer->create but not necessarily $producer->save unless you are doing something specific.

3. Finally you can play around within the theming for your entity by looking into producer.tpl.php and
producer-sample-data.tpl.php
